...
\author{Ivo Blöchliger, Jirayu Ruh}  % Autor festlegen
...
pdfkeywords={\paperinstitution} {\papersupervisor} % Schlüsselwörter
    {Puzzle} {Generator} {Trennlinien} {Schnittkurven},
...
/Author (\paperauthor)
/Subject (\papertype)
/Keywords (\paperinstitution;\papersupervisor;Puzzle;Generator;Trennlinien;Schnittkurven)
}
% ========== ENDE VON METADATEN ===========
...
\input{Piezoelectric_Elements.tex} %       \
\input{Experiment.tex} %        \
\input{Theoretical_Approaches.tex} %     \
\input{Analysis.tex} %      \
